...
ActiveRecord::Schema.define(version: 2018_08_04_140916) do
  ...
  create_table "developer_projects", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_developer_projects_on_user_id"
  end
  ...
  add_foreign_key "developer_projects", "users"
